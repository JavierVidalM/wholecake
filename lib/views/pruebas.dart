  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.separated(
          itemCount: listado.ListadoPastelesDisplay.length,//tripulacion.length,//establece el tamaño
          itemBuilder: (context, index) => ListTile(
            leading: const Icon(Icons.people_rounded),
            title: Text(listado.ListadoPastelesDisplay[index].nombre), //Text(tripulacion[index]),
