...
//    TextEditingController _fechaElaboracionController =
//       TextEditingController();
//    TextEditingController _fechaVencimientoController =
//       TextEditingController();
...
//     _fechaElaboracionController = product.fechaElaboracion;
//     _fechaVencimientoController = product.fechaVencimiento;
//     _priceController.text = product.precio.toString();
//   }

//   @override
//   Widget build(BuildContext context) {
//     final productForm = Provider.of<ProductService>(context);
//     final product = productForm.listadoproductos.firstWhere(
//       (product) => product.productoId == widget.productId,
//       orElse: () => Listado(
//         productoId: 0,
//         nombre: '',
